...
public class MyHoardContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.techhue.hoardcontentprovider/hoards");
    ...
    static {
        ...
        uriMatcher.addURI("com.techhue.hoardcontentprovider", "hoards", ALLROWS);
        uriMatcher.addURI("com.techhue.hoardcontentprovider", "hoards/#", SINGLE_ROW);
    }
...
//  }
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case ALLROWS:
                return "vnd.android.cursor.dir/vnd.techhue.hoarded";
            case SINGLE_ROW:
                return "vnd.android.cursor.item/vnd.techhue.hoarded";
            default:
