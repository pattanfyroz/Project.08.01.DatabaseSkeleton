...
public class DatabaseSkeletonActivity extends Activity {
    ...
    MyHoardContentProvider myHoardContentProvider;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button getLargeHordNameButton = (Button) findViewById(R.id.getLargeHordName);
        getLargeHordNameButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hordName = getLargestHoardName();
                resultTextView.setText(hordName);
            }
        });

        Button addARowButton = (Button) findViewById(R.id.addARow);
        addARowButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri afterAddedURI = addNewHoard("TechHue", 45.0f, true);
                Log.d(TAG, "New URI = " + afterAddedURI);
                resultTextView.setText("Added URI = " + afterAddedURI.toString());
            }
        });

        Button getRowButton = (Button) findViewById(R.id.getRow);
        getRowButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cursor resultCursor = getRow(1);
                ...
                String hordName = resultCursor.getString(HOARD_NAME_COLUMN_INDEX);
                resultTextView.setText(hordName);
            }
        });

        Button deleteEmptyHordsButton = (Button) findViewById(R.id.deleteEmptyHords);
        deleteEmptyHordsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int deletedRows = deleteEmptyHoards();
                resultTextView.setText("No.Of deleted Rows = " +  deletedRows);
            }
        });

        Button updateHordsButton = (Button) findViewById(R.id.updateHords);
        updateHordsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int updateRowCount = updateHoardValue(1, 50.0f);
                resultTextView.setText("No.Of Updated Rows = " +  updateRowCount);
            }
        });

        Button addHordWithImageButton = (Button) findViewById(R.id.addHordWithImage);
        addHordWithImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.kabali);

                addNewHoardWithImage("Kabali", 100.00f, true, bitmap);
            }
        });

        Button getHordImageButton = (Button) findViewById(R.id.getHordImage);
        getHordImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Bitmap bitmap = getHoardImage(4);
                ...
                {
                    resultTextView.setText("No Image Found");
                }
            }
        });
    ...
    private String getLargestHoardName() {
        ...
        String[] result_columns = new String[]{
                ...
                MyHoardContentProvider.KEY_GOLD_HOARD_IMAGE_COLUMN
        };
